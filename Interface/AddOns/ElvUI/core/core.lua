...
function E:Print(...)
	...
	(_G[self.db.general.messageRedirect] or _G.DEFAULT_CHAT_FRAME):AddMessage(strjoin('', hexvaluecolor, 'EUI:|r ', ...)) -- I put DEFAULT_CHAT_FRAME as a fail safe.
end
...
function E:DBConversions()
	...
	-- if E.private.nameplates_v1 and E.private.nameplates_v1.enabled then
		-- E.private.nameplates.enabled = true
		-- E.private.nameplates_v1 = nil
		-- E.db.nameplates_v1 = nil
	-- end
...
function E:ExecuteChatCommand(text)
	if text and text:sub(1, 1) == "." then
		...
		local _, catch = pcall(_G.ChatEdit_SendText, _G.ChatFrame1EditBox);
		if catch then
			return false;
		else
			return true;
