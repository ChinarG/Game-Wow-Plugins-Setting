...
kDefaultConfig5.UserScale = 2.0
kDefaultConfig5.UserAlpha = 0.75
...
function Profiles_Load(profileName)
    ...
    elseif isEmpty(Globals.CursorTrail_Config.Profiles[profileName]) then
        ...
        CursorModel_Load()
        print(kAddonName..": Loaded profile '"..ORANGE..profileName.."|r'.")
    end
end
...
function Profiles_Save(profileName)
    if (profileName == nil or profileName == "") then
        ...
        print(kAddonName..": Saved profile '"..ORANGE..profileName.."|r'.")
    end
end
...
function Profiles_Delete(profileName)
    ...
    elseif isEmpty(Globals.CursorTrail_Config.Profiles[profileName]) then
        ...
        print(kAddonName..": Deleted profile '"..ORANGE..profileName.."|r'.")
    end
end
